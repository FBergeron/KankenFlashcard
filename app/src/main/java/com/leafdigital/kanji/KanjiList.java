        ...
        case FUZZY_2OUT:
            {
                ...
                if(compare.getStrokeCount() > 0)
                {
                    // Do either -2 and +2, -1 and +1, or just 0.
                        ...
                        // Actually, as I have commented the loop below and
                        // initialized the count using only strokeCount + range,
                        // I rather do just +2, +1 or 0.
                        // The idea is that most of the time, users draw fewer strokes
                        // because it's faster.  To optimize the search, I do not compute 
                        // -2, -1. - FB
